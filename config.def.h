...
static const char dmenufont[]       = "FuraCode Nerd Font:size=10:antialias=true:autohint=true";
...
static const char *voldwcmd[] = { "pactl", "set-sink-volume", "0", "-5%", NULL };
static const char *volmutetogcmd[] = { "pactl", "set-sink-mute", "0", "toggle", NULL };
